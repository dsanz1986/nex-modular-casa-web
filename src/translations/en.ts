export const en = {
  ...
  models: {
    ...
    specialOffer: "SPECIAL LIMITED OFFER UNTIL JANUARY 31ST!",
    reservationDeadline: "Reserve before January 31st",
    nexNatura: {
      name: "Nex Natura",
  ...
  advantages: {
    ...
    items: {
      ...
      pilotHouse: {
        title: "Pilot house available to visit",
        description: "Come to Campo Real (Madrid) and experience how it feels to live"
      }
    }
  },
  licenses: {
