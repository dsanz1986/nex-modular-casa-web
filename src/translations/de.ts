...
export const de = {
  ...
  models: {
    ...
    specialOffer: "BEFRISTETES SONDERANGEBOT BIS 31. JULI!",
    reservationDeadline: "Reservierungen vor dem 31. Juli",
    nexNatura: {
      name: "Nex Natura",
  ...
  advantages: {
    ...
    items: {
      ...
      readyToInstall: {
        title: "Installationsbereit geliefert",
  ...
  faq: {
    ...
    items: {
      ...
      personalizacion: {
        ...
        answer: "Absolut. Unsere mobilen Modulhäuser sind vollständig anpassbar. Sie können Innenaufteilung, Oberflächen, Farben, Bodenbelagstypen, Küche, Badezimmer und alle Details wählen, die Ihr Zuhause einzigartig machen. Wir arbeiten mit Ihnen vom Design bis zur endgültigen Lieferung."
      }
    }
  },
  testimonials: {
  ...
  contact: {
    title: "Informationen unverbindlich anfordern",
    subtitle: "Teilen Sie uns Ihre Bedürfnisse mit und wir helfen Ihnen, das perfekte Modulhaus für Sie zu finden",
    form: {
      name: "Name",
      email: "E-Mail",
      phone: "Telefon",
  ...
  cookies: {
    ...
    preferences: {
      ...
      marketing: {
        ...
        description: "Um Ihnen personalisierte und relevante Inhalte zu zeigen."
      },
      cancel: "Abbrechen",
